package com.dwes.todo_rest.error;
...
public class GlobalErrorController
    ...
    public ProblemDetail handleProductNotFound(TaskNotFoundException ex) {
        ...
        result.setType(URI.create("https://www.dwes.net/errors/task-not-found"));
        return result;
    }
    ...
    public ProblemDetail handleAuthException(AuthenticationException ex) {
        ...
        result.setType(URI.create("https://www.dwes.net/errors/authentication"));
        return result;
    }
    ...
    public ProblemDetail handleAccessDeniedException(AccessDeniedException ex) {
        ...
        result.setType(URI.create("https://www.dwes.net/errors/authorization"));
        return result;
    }
}
